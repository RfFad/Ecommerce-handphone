...
<body>
    ...
    <?php 
        ...
        inner join checkout on detail.id_checkout = checkout.id_checkout
        where detail.id_checkout='$id'";
    ...
    ?>
        ...
        <div class="table-responsive">
            ...
            inner join produk on detail.id_pembeli = produk.id_pembeli 
            where detail.id_checkout='$_GET[id]'";
